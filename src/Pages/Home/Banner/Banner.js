    ...
    return (
        <div className='h-screen bg-banner-img bg-blend-multiply bg-no-repeat bg-center bg-cover flex flex-col justify-center items-center'>
            <div className='text-neutral'>
                <h2 className='w-full text-5xl md:text-8xl font-thin md:tracking-[30px] animate-bottom-top-fade-in'>Welcome To <br /> <span className='font-medium mt-5 block'>Car Arena</span></h2>
